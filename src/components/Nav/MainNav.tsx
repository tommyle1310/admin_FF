...
const MainNav = () => {
    return (
        <div className="jb w-full gap-4 py-8">
            ...
            <Input type="email" placeholder="Search here..." className="bg-white flex-1" />
            <div className=" jb gap-8 ">
                <div className="jb gap-4 max-md:hidden">
                    <div className="w-10 aspect-square rounded-xl relative cc bg-info-100 shadow-md shadow-info-300 hover-sd">
                        ...
                        <Badge className="absolute -top-1 -right-1 border-2 border-white text-[0.5rem] px-[0.14rem] py-[0.1rem] bg-info-500" variant="default">12</Badge>
                    </div>
                    ...
                    <div className="w-10 aspect-square rounded-xl relative cc bg-danger-100 shadow-md shadow-danger-300 hover-sd">
                        ...
                        <Badge className="absolute -top-1 -right-1 border-2 border-white text-[0.5rem] px-[0.14rem] py-[0.1rem] bg-danger-500" variant="default">12</Badge>
                    </div>
                </div>
